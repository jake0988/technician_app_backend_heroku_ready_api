...
import EditPianoForm from "./components/pianos/EditPianoForm";
          ...
          <Stack gap={3}>
            ...
            <Switch>
              ...
              />
               <Route
                exact
                path="/users/:user_id/customers/:customer_id/pianos/:piano_id/edit"
                render={(props) => {
                  return (
                    <EditPianoForm
                      history={props.history}
                      userId={props.match.params.user_id}
                      customerId={props.match.params.customer_id}
                      piano={props.match.params.piano_id}
                    />
                  );
                }}
              />
